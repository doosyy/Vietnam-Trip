...
function Activity({ a, onLinkOpenMap }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: `activity ${open ? "open" : ""}` }, /* @__PURE__ */ React.createElement("button", { className: "activity-toggle", onClick: () => setOpen((o) => !o), "aria-expanded": open }, /* @__PURE__ */ React.createElement("span", { className: `activity-time ${isClockTime ? "is-clock" : "is-fuzzy"}` }, a.time), /* @__PURE__ */ React.createElement("span", { style: { display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement("span", { className: `activity-mood mood-${a.mood}` }), /* @__PURE__ */ React.createElement("span", { className: "activity-title" }, a.title)), /* @__PURE__ */ React.createElement("span", { className: "activity-caret" }, /* @__PURE__ */ React.createElement(Icon.Plus, { s: 16 }))), /* @__PURE__ */ React.createElement("div", { className: "activity-body" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "activity-detail" }, a.detail, (a.link || a.url) && /* @__PURE__ */ React.createElement("div", { className: "activity-actions" }, a.link && /* @__PURE__ */ React.createElement("button", { className: "btn-ghost", onClick: () => onLinkOpenMap == null ? void 0 : onLinkOpenMap(a.link) }, /* @__PURE__ */ React.createElement(Icon.Map, { s: 11 }), " \xA0 View on Map"), a.url && /* @__PURE__ */ React.createElement("a", { className: "btn-ghost", href: a.url, target: "_blank", rel: "noopener noreferrer" }, /* @__PURE__ */ React.createElement(Icon.Arrow, { s: 11 }), " \xA0 Tour details"))))));
}
