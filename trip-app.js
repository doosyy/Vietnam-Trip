...
function Dashboard() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "dashboard reveal" }, /* @__PURE__ */ React.createElement("div", { className: "dashboard-inner" }, /* @__PURE__ */ React.createElement("div", { className: "dash-weather" }, /* @__PURE__ */ React.createElement("div", { className: "dash-head" }, /* @__PURE__ */ React.createElement("span", { className: "label" }, "Weather Now"), /* @__PURE__ */ React.createElement("div", { className: "city-select", role: "tablist" }, cities.map((c) => /* @__PURE__ */ React.createElement("button", { key: c, className: city === c ? "on" : "", onClick: () => setCity(c) }, c.split(" ").map((w2) => w2[0]).join("").slice(0, 3))))), /* @__PURE__ */ React.createElement("div", { className: "weather-now" }, /* @__PURE__ */ React.createElement("div", { className: "weather-icon" }, window.weatherIcon(w.icon, 30)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "weather-temp" }, w.temp, /* @__PURE__ */ React.createElement("sup", null, "\xB0C")), /* @__PURE__ */ React.createElement("div", { className: "weather-cond" }, city, " \xB7 ", w.cond)), /* @__PURE__ */ React.createElement("div", { className: "weather-side" }, /* @__PURE__ */ React.createElement("span", { className: "weather-pill" }, "H ", w.hi, "\xB0 \xB7 L ", w.lo, "\xB0"), /* @__PURE__ */ React.createElement("span", { className: "weather-pill" }, "AQI ", w.aqi)))), /* @__PURE__ */ React.createElement("div", { className: "dash-fx" }, /* @__PURE__ */ React.createElement("div", { className: "dash-head" }, /* @__PURE__ */ React.createElement("span", { className: "label" }, "AUD \u21C4 VND"), /* @__PURE__ */ React.createElement("span", { className: "label", style: { color: "var(--fg-muted)" } }, "1 A$ \u2248 ", rate.toLocaleString(), " \u20AB")), /* @__PURE__ */ React.createElement("div", { className: "fx-row" }, flipped ? vndSide : audSide, /* @__PURE__ */ React.createElement("div", { className: "fx-swap-wrap" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      className: "fx-swap",
...
function App() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Hero, { onScrollDown: scrollPastHero }), /* @__PURE__ */ React.createElement(Dashboard, null), /* @__PURE__ */ React.createElement(DayBar, { active: activeDay, onJump: jumpToDay, onJumpSection: jumpToSection }), /* @__PURE__ */ React.createElement(
    Itinerary,
    {
      onOpenMap: openMap,
